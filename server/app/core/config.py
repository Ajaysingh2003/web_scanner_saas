...
class Settings(BaseSettings):
    ...
    retention_scan_days: int = 365
    retention_auth_days: int = 30
    retention_payment_webhook_days: int = 180
    retention_monitoring_days: int = 90
    retention_disabled_integration_days: int = 30
    smtp_host: str = ""
    smtp_port: int = 587
    smtp_username: str = ""
    smtp_password: str = ""
